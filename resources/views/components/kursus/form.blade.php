<div class="w3-half w3-light-grey w3-container" style="height:100vh">
    <div class="w3-padding-64 w3-center">
        ...
        <div class="w3-left-align w3-padding-large">
            ...
            <input class="w3-grey" type="text" name="nama" id="nama"
                value="{{ old('nama', $kursus->nama ?? '') }}">
      
            <label for="deskripsi">Deskripsi</label>
            <textarea class="w3-grey" name="deskripsi" id="deskripsi">{{ old('deskripsi', $kursus->deskripsi ?? '') }}</textarea>

            <label for="durasi">Durasi</label>
            <input class="w3-grey" type="text" name="durasi" id="durasi" value="{{ old('durasi', $kursus->durasi ?? '') }}">
